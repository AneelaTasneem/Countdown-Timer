...
return (
  ...
  <div className="flex flex-col items-center justify-center h-screen bg-sky-400 dark:bg-sky-900">
    {/* Timer box container */}
    <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
      ...
      <div className="flex items-center mb-6">
        ...
        <Button
          ...
          variant="outline"
          className="text-white bg-blue-700 hover:bg-blue-800 border-blue-700 hover:border-blue-800"
        >
          Set
        </Button>
      </div>
